 ...
 *  BUFF - Increase your player's force by 'force' points of CardStats.
 *  HEAL - Increase your player's HP by 'heal' points  of CardStats (no more than maxHP points).
 *  TREASURE - Get 'loot' coins of CardStats.
*/
